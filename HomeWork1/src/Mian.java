...
public class Mian {
	...
	private static List<Artist> getAllArtist() {
		...
		artist2.setId(2);
		artist2.setName("ខេមរៈ សិរីមន្");
		Artist artist3 = new Artist();
		artist3.setId(3);
		artist3.setName("មាសសុខសោភា");
		Artist artist4 = new Artist();
		artist4.setId(4);
		artist4.setName("តន់ ចន្ទសីម៉ា");
		Artist artist5 = new Artist();
		artist5.setId(5);
		artist5.setName("ពេជ្យ សូលីកា");
		Artist artist6 = new Artist();
		artist6.setId(6);
		artist6.setName("ថុល សុភិទិ");
		Artist artist7 = new Artist();
		artist7.setId(7);
		artist7.setName("សួរ វិចិត្");
		Artist artist8 = new Artist();
		artist8.setId(8);
		artist8.setName("អនុស្សាវរីយ៍");
		Artist artist9 = new Artist();
		artist9.setId(9);
		artist9.setName("ដួង វីរៈសិទ្");
		Artist artist10 = new Artist();
		artist10.setId(10);
		artist10.setName("បូលីពៅ");
